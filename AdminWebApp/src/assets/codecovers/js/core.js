var themeCore = function () {
  ...
  (function (namespace, $) {
    ...
    p._enableEvents = function () {
      ...
      $('.offcanvas').filter(function (i) { return !$(this).attr("gnit") }).on('refresh', function (e) {
        o.evalScrollbar(e);
      }).attr('gnit', 1);

      $('[data-toggle="offcanvas"]').filter(function (i) { return !$(this).attr("gnit") }).on('click', function (e) {
        e.preventDefault();
        o._handleOffcanvasOpen($(e.currentTarget));
      }).attr('gnit', 1);

      $('[data-dismiss="offcanvas"]').filter(function (i) { return !$(this).attr("gnit") }).on('click', function (e) {
        o._handleOffcanvasClose();
      }).attr('gnit', 1);

      $('#base').filter(function (i) { return !$(this).attr("gnit") }).on('click', '> .backdrop', function (e) {
        o._handleOffcanvasClose();
      }).attr('gnit', 1);

      $('[data-toggle="offcanvas-left"].active').filter(function (i) { return !$(this).attr("gnit") }).each(function () {
        o._handleOffcanvasOpen($(this));
      }).attr('gnit', 1);

      $('[data-toggle="offcanvas-right"].active').filter(function (i) { return !$(this).attr("gnit") }).each(function () {
        o._handleOffcanvasOpen($(this));
      }).attr('gnit', 1);
    };
    p._handleScreenSize = function (e) {
    ...
    p.openOffcanvas = function (id) {
      ...
      $(id + '.active').css({
        ...
        //angular.element(document.body).injector().get("dataHelper").call(function (g) { alert(g); }, 1000)('grs');
      });
    };
  ...
  (function (namespace, $) {
    ...
    p._enableEvents = function () {
      var o = this;
      $('.navbar-search .btn').filter(function (i) { return !$(this).attr("gnit") }).on('click', function (e) {
        o._handleButtonClick(e);
      }).attr('gnit', 1);

      $('.navbar-search input').filter(function (i) { return !$(this).attr("gnit") }).on('blur', function (e) {
  ...
  (function (namespace, $) {
    ...
    p._initTabs = function () {
      ...
      $('[data-toggle="tabs"] a').filter(function (i) { return !$(this).attr("gnit") }).click(function (e) {
        e.preventDefault();
        $(this).tab('show');
      }).attr('gnit', 1);
    };
