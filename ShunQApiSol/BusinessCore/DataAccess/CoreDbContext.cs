    ...
    public class CoreDbContext : DbContext
    {
     ...
     .HasData(
         new UserRole
         {
            ...
            //pdf
            var barcodeList = new List<BarcodeDummyItem>
            {
                new BarcodeDummyItem {ProductId="1", BarCode="811571013579",Weight=200F},
                new BarcodeDummyItem {ProductId="2", BarCode="705632441947",Weight=500F},
                new BarcodeDummyItem {ProductId="3", BarCode="9780123456786",Weight=500F},
                new BarcodeDummyItem {ProductId="4", BarCode="9771234567003",Weight=300F},
                new BarcodeDummyItem {ProductId="5", BarCode="036000291452",Weight=200F},
                new BarcodeDummyItem {ProductId="6", BarCode="9501101530003",Weight=100F},
            };
            //--
            ...
            productList.ForEach(o =>
            {
                ...
                var barcode = barcodeList.Find(x => x.ProductId == o.Id);
                priceList.Add(new PriceMaster
                {
                    ...
                    Weight= barcode !=null ? barcode.Weight:100F,
                    WeightUnit="gm",
                    CompanyId = 1,
                    CreatedOn = DateTime.Now,
                    CreatedBy = 1,
            ...
            var pBarcodeList = new List<ProductBarcode>();

            barcodeList.ToList().ForEach(o =>
            {
                pBarcodeList.Add(new ProductBarcode
                {
                    Id = pBarcodeList.Count+1,
                    ProductMasterId = o.ProductId,
                    Code = o.BarCode,
                    CompanyId = 1,
                    CreatedOn = DateTime.Now,
                    CreatedBy = 1,
            ...
            modelBuilder.Entity<ProductBarcode>().HasData(pBarcodeList);
            #endregion "ProductBarcode"
